...
final class SwiftTagAppleScriptUITests: SwiftTagUITestCase {
    ...
    @MainActor
    func testAppleScriptHarnessReadsEditorWindowModifiedState() throws {
        try scenarioAppleScriptHarnessReadsEditorWindowModifiedState()
    }
    ...
    @MainActor
    func testAppleScriptHarnessMakesTrackPicturesFromAppleScriptImageData() throws {
        try scenarioAppleScriptHarnessMakesTrackPicturesFromAppleScriptImageData()
    }
